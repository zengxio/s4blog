...
class UserInfo(models.Model):
    ...
    #DateTimeField.auto_now     需要存储“最后修改时间”的场景下，不能被修改
    #DateTimeField.auto_now_add 被用在存储“创建时间”的场景下,不能被修改
...
class Blog(models.Model):
    ...
    user = models.OneToOneField(to='UserInfo', to_field='nid') #fk+unique
